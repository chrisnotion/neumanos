...
const QUEST_TEMPLATES: QuestTemplate[] = [
  ...
  },
  {
    type: 'early-bird',
    title: () => '早起小达人',
    description: () => '在中午 12:00 前完成至少一个习惯打卡',
    icon: '🌅',
    xpReward: 60,
    getTarget: () => 1,
  },
  {
    type: 'try-new',
    title: () => '重拾遗忘的习惯',
    description: () => '打卡一个过去 7 天以上未打卡的习惯',
    icon: '🔄',
    xpReward: 70,
    getTarget: () => 1,
  },
  {
    type: 'consistency',
    title: () => '持之以恒',
    description: () => '拥有至少一个连续打卡 3 天以上的习惯',
    icon: '📈',
    xpReward: 45,
    getTarget: () => 1,
  },
