                      ...
                      <td className="px-4 py-3 text-sm text-text-light-secondary dark:text-text-dark-secondary whitespace-nowrap">
                        {entry.projectId ? (
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span>{projects.find(p => p.id === entry.projectId)?.name || '未知项目'}</span>
                          </div>
                        ) : (
                          <span className="text-text-light-tertiary dark:text-text-dark-tertiary italic">未归属项目</span>
                        )}
                      </td>
                      <td className="px-4 py-3 text-sm text-text-light-secondary dark:text-text-dark-secondary whitespace-nowrap">
