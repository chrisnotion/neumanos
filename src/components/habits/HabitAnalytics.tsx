...
function buildWeeklyTrend(
  ...
  for (let weekOffset = 11; weekOffset >= 0; weekOffset--) {
    ...
    points.push({ label: `${month}月${day}日`, rate });
  }
...
function buildTimeDistribution(completions: HabitCompletion[]): TimeDistData[] {
  ...
  return [
    { period: '早间 (6:00-12:00)', count: morning, color: '#f97316' },
    { period: '午后 (12:00-18:00)', count: afternoon, color: '#3b82f6' },
    { period: '晚间 (18:00-24:00)', count: evening, color: '#8b5cf6' },
  ];
}
