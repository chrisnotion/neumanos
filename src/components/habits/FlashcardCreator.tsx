            ...
            {showNewDeck && (
              <div className="flex gap-2 mt-2">
                <input
                  ...
                  placeholder="输入新卡包名称..."
                  className="flex-1 px-3 py-1.5 text-sm rounded-lg border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark text-text-light-primary dark:text-text-dark-primary focus:outline-none focus:ring-2 focus:ring-accent-primary"
            ...
            <>
              <div className="mb-2">
                ...
                <textarea
                  ...
                  placeholder={"React 是什么？ | 一个声明式的 UI 构建库\nHTTP 200 含义 :: 请求成功"}
                  rows={8}
