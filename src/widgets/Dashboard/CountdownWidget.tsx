            ...
            {events.map((event) => {
              ...
              return (
                ...
                >
                  ...
                  {timeLeft.expired ? (
                    <p className="text-status-error text-xs">已到达预定时间！</p>
                  ) : (
                    <div className="grid grid-cols-4 gap-2 text-center">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-text-light-secondary dark:text-text-dark-secondary">分钟</div>
                      </div>
                      <div>
